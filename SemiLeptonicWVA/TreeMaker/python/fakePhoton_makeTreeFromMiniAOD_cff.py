...
#    process.slimmedJetsPFCombinedSecondaryVertexBJetTags
    ...
    if (MC):
        jecLevelsAK8 = [
            "JEC/Summer15_25nsV2_MC_L1FastJet_AK8PFchs.txt",
            "JEC/Summer15_25nsV2_MC_L2Relative_AK8PFchs.txt",
            "JEC/Summer15_25nsV2_MC_L3Absolute_AK8PFchs.txt"
            ]
        jecLevelsAK4 = [
            "JEC/Summer15_25nsV2_MC_L1FastJet_AK4PFchs.txt",
            "JEC/Summer15_25nsV2_MC_L2Relative_AK4PFchs.txt",
            "JEC/Summer15_25nsV2_MC_L3Absolute_AK4PFchs.txt"
            ]
...
#        dataFormat = DataFormat.MiniAOD 
    ...
    ## Add in photon-like jets (fake photons):
    from SemiLeptonicWVA.Utils.fakephoton_cfi import fakephoton
    process.PhotonLikeJets = fakephoton.clone(
        PhoTag = cms.InputTag("slimmedPhotons"),
        phoLooseIdMap = cms.InputTag("egmPhotonIDs:cutBasedPhotonID-Spring15-50ns-V1-standalone-loose"),
        phoMediumIdMap = cms.InputTag("egmPhotonIDs:cutBasedPhotonID-Spring15-50ns-V1-standalone-medium"),
        phoTightIdMap = cms.InputTag("egmPhotonIDs:cutBasedPhotonID-Spring15-50ns-V1-standalone-tight"),
        phoTightIdFullInfoMap = cms.InputTag("egmPhotonIDs:cutBasedPhotonID-Spring15-50ns-V1-standalone-tight")
    )
...
#    BTagInputTag	        = cms.string('combinedInclusiveSecondaryVertexV2BJetTags'),
    ...
    if (MC):
        process.MHTJetsProperties.L1File = cms.string("JEC/Summer15_25nsV2_MC_L1FastJet_AK4PFchs.txt")
        process.MHTJetsProperties.L2File = cms.string("JEC/Summer15_25nsV2_MC_L2Relative_AK4PFchs.txt")
        process.MHTJetsProperties.L3File = cms.string("JEC/Summer15_25nsV2_MC_L3Absolute_AK4PFchs.txt")
        process.MHTJetsPropertiesAK8.L1File = cms.string("JEC/Summer15_25nsV2_MC_L1FastJet_AK8PFchs.txt")
        process.MHTJetsPropertiesAK8.L2File = cms.string("JEC/Summer15_25nsV2_MC_L2Relative_AK8PFchs.txt")
        process.MHTJetsPropertiesAK8.L3File = cms.string("JEC/Summer15_25nsV2_MC_L3Absolute_AK8PFchs.txt")
...
#    BTagInputTag	        = cms.string('combinedInclusiveSecondaryVertexV2BJetTags'),
    ...
    if (MC):
        process.JetsProperties.L1File = cms.string("JEC/Summer15_25nsV2_MC_L1FastJet_AK4PFchs.txt")
        process.JetsProperties.L2File = cms.string("JEC/Summer15_25nsV2_MC_L2Relative_AK4PFchs.txt")
        process.JetsProperties.L3File = cms.string("JEC/Summer15_25nsV2_MC_L3Absolute_AK4PFchs.txt")
        process.JetsPropertiesAK8.L1File = cms.string("JEC/Summer15_25nsV2_MC_L1FastJet_AK8PFchs.txt")
        process.JetsPropertiesAK8.L2File = cms.string("JEC/Summer15_25nsV2_MC_L2Relative_AK8PFchs.txt")
        process.JetsPropertiesAK8.L3File = cms.string("JEC/Summer15_25nsV2_MC_L3Absolute_AK8PFchs.txt")
...
#    jecPayloadNames      = cms.vstring(jecLevelsAK4),
    ...
    if (MC):
        process.MET.L1File = cms.string("JEC/Summer15_25nsV2_MC_L1FastJet_AK4PFchs.txt")
        process.MET.L2File = cms.string("JEC/Summer15_25nsV2_MC_L2Relative_AK4PFchs.txt")
        process.MET.L3File = cms.string("JEC/Summer15_25nsV2_MC_L3Absolute_AK4PFchs.txt")
...
# 
    ...
    RecoCandVector.extend(['PhotonLikeJets(PhotonLikeJets)|PhotonLikeJets:isLoose(b_isLoose)|PhotonLikeJets:isMedium(b_isMedium)|PhotonLikeJets:isTight(b_isTight)'] ) # fake photon information on various variables
