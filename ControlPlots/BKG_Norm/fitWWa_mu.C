...
const float IntLUMI = 2.17;
RooRealVar *mjj_;
using namespace RooFit;

RooHistPdf*  makePdf(TH1D*, char*);
void cmsPrelim2();
...
void fitWWa_mu(){
  ...
  TH1D* data_obs = (TH1D*) fin->Get("Muon/vbf_maxpt_jj_m/data_obs");
  TH1D* th1fkdata = (TH1D*) fin->Get("Muon/vbf_maxpt_jj_m/th1FakePhotons");
  TH1D* th1wwa = (TH1D*) fin->Get("Muon/vbf_maxpt_jj_m/th1wwa");
  TH1D* th1wza = (TH1D*) fin->Get("Muon/vbf_maxpt_jj_m/th1wza");
  TH1D* th1wajets = (TH1D*) fin->Get("Muon/vbf_maxpt_jj_m/th1wajets");
  TH1D* th1zajets = (TH1D*) fin->Get("Muon/vbf_maxpt_jj_m/th1zajets");
  TH1D* th1Top = (TH1D*) fin->Get("Muon/vbf_maxpt_jj_m/th1ttajets");
  TH1D* th1tajets = (TH1D*) fin->Get("Muon/vbf_maxpt_jj_m/th1tajets");
